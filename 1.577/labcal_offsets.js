(window.LabCalBuild = window.LabCalBuild || {})['labcal_offsets.js'] = 'v1.577';  // file version — see labcal_build.js
/* ---------------------------------------------------------------------
...
(function (global) {
  ...
  var DEVICES = {
    dostmann: {
      ...
      used: 'Barkey · Standard Medical · Non-Standard Medical · IBB'   // v1.555: matches OFFSET_DEVICE in each worksheet
    },
    fluke_comark: {
      id: 'fluke_comark',
      name: 'Fluke & Comark',
