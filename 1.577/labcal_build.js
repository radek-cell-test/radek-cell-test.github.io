/* LabCal — file version check (introduced v1.574).
 *
 ...
 *
 *   page:     <meta name="labcal-build" content="v1.575">
 *   modules:  first line  (window.LabCalBuild = …)['labcal_x.js'] = 'v1.575';
...
(function (global) {
  ...
  function mismatches() {
    ...
    loadedModules().forEach(function (f) {
      ...
      var v = reg[f];
      if (v !== want) bad.push({ file: f, version: v || 'from before v1.574' });
    });
