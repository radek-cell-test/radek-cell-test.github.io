...
(function (global) {
  ...
  function markDone(serial, certRef, extra) {
    ...
    var l = link();
    if (l && l.jobRef && jobKey((current() || {}).callNumber) !== jobKey(l.jobRef) && jobsStore()[jobKey(l.jobRef)]) {
      return withJob(l.jobRef, function () { return markDone(serial, certRef, extra); });
    }
