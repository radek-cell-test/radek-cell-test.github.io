(window.LabCalBuild = window.LabCalBuild || {})['labcal_vector_pdf.js'] = 'v1.574';  // file version — see labcal_build.js
/* ---------------------------------------------------------------------
  ...
  function buildCloudTemp(opts) {
    ...
    function drawFooter(y) {
      ...
      [['Engineer Name', val('engineer'), txtOf('engSignature') || val('engineer'), dateField(val('engDate') || val('date')), true],
       ...
       ['Checked By (Name)', val('checkedBy'), '' /* v1.574: signed by hand, like the other worksheets */, val('checkedBy') ? dateField(val('checkDate')) : '', false]
